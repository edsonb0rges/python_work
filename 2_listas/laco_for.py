...
# Como a lista magicos foi armazenada como variável magico, o interpretador irá repetir todo o laço mais de uma vez, até o último elemento da lista. Ao encerrar esse processo, o interpretador passa para o próximo passo do código.
# Tenha em mente que o conjunto de passos será repetido, uma vez para cada item da lista, não importa quantos itens haja na lista
    ...
    # Perceba que o laço "for" está retornando todo o comando, depois que ele passa para o próximo item (mágico) da lista.

print("Obrigado, pessoal. Foi um grnde show de mágica!")
